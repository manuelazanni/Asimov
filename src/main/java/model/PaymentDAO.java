    ...
    public void doSave(PaymentBean payment)
    {
        try (Connection con = ConPool.getConnection()) {
            PreparedStatement ps = con.prepareStatement(
                    "INSERT INTO Pagamento (ID_Ordine, Data_Pagamento, Numero_Carta, CVV, Scadenza, Titolare_Carta) VALUES (?,?,?,?,?,?)");
            ...
            ps.setString(5, payment.getExpiration());
            ps.setString(6, payment.getNameUserCard());
